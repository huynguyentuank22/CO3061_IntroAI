...
class MosaicUI:
    def __init__(self, width=800, height=600):
        ...
        self.mosaic = Mosaic("testcases/tc2.txt")  # You can change the input file
    ...
    def solve_puzzle(self, algorithm):
        ...
        if algorithm == 'solve_dfs':
            solution = self.mosaic.solve_by_DFS()
        elif algorithm == 'solve_bfs':
            solution = self.mosaic.solve_by_BFS()
        elif algorithm == 'solve_a*':
            solution = self.mosaic.solve_by_A_star()
